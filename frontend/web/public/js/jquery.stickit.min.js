...
(function (b, g, h, k) {
    function c(a, d) {
        this.element = b(a);
        this.options = d || {};
        this.options.scope = this.options.scope || l.Parent;
        ...
        this.options.zIndex === k && (this.zIndex = this.element.css("z-index") || 100, "auto" == this.zIndex && (this.zIndex = 100));
        ...
        this.spacer.css({display: "none", visibility: "hidden"});
    ...
    function n() {
        ...
        m = g.innerWidth || h.documentElement.clientWidth;
    ...
    var q = -1 != navigator.userAgent.indexOf("MSIE 7.0"), r = q ? -2 : 0, l = g.StickScope = {Parent: 0, Document: 1},
        e = {None: 0, Fixed: 1, Absolute: 2}, t = !1;
    ...
    c.prototype.bound = function () {
        var a = this.element;
        if (q || "border-box" != a.css("box-sizing")) this.extraWidth = 0; else {
            var d = parseInt(a.css("border-left-width")) || 0, f = parseInt(a.css("border-right-width")) || 0,
                b = parseInt(a.css("padding-left")) || 0, c = parseInt(a.css("padding-right")) || 0;
        ...
        this.margin = {
            ...
            right: parseInt(a.css("margin-right")) ||
                0
        };
    ...
    c.prototype.updateScroll = function (a) {
        0 != this.offsetHeight && (this.offsetY = Math.max(this.offsetY + a - this.lastY, -this.offsetHeight), this.offsetY = Math.min(this.offsetY, 0), this.lastY = a, this.element.css("top", this.options.top + this.offsetY + "px"))
    };
    c.prototype.isActive = function () {
        return (this.options.screenMinWidth === k || m >= this.options.screenMinWidth) && (this.options.screenMaxWidth ===
            k || m <= this.options.screenMaxWidth) && this.element.is(":visible")
    };
    c.prototype.locate = function () {
        ...
        if (this.isActive()) switch (this.stick) {
            case e.Fixed:
                ...
                0 <= d ? this.reset() : this.options.scope == l.Parent ? (a = b.parent()[0].getBoundingClientRect(), a.bottom + this.baseParentOffset + this.offsetHeight <= b.outerHeight(!1) + this.basePadding ? this.setAbsolute(this.spacer.position().left) : this.updateScroll(a.bottom)) : this.updateScroll(a.bottom);
                break;
            case e.Absolute:
                a = c[0].getBoundingClientRect();
                d = a.top - this.baseTop;
            ...
            default:
                ...
                c.show();
                f = a.left - this.margin.left;
                this.options.scope == l.Document ? this.setFixed(f, a.bottom, 0) : b.parent()[0].getBoundingClientRect().bottom +
                this.baseParentOffset <= b.outerHeight(!1) + this.basePadding ? this.setAbsolute(this.element.position().left) : this.setFixed(f + r, a.bottom, 0);
    ...
    b.fn.stickit = function (a, d) {
        "string" == typeof a ? -1 != b.inArray(a, v) && this.each(function () {
            ...
            c && c[a].apply(c, d)
        }) : (t || (t = !0, n(), b(h).ready(function () {
            b(g).bind("resize", n).bind("scroll", u)
